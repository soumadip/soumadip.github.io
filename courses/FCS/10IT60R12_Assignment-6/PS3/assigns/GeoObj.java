...
class Rectangle extends GeoObject
{
	...
	public void printIt ()
	{
		System.out.println("Rectangle: base = (" + baseX + ", " + baseY + ")");
		System.out.println("height = " + itsHeight + ", width = " + itsWidth + ", area = " + itsArea + ".");
	}
}
...
class Circle extends GeoObject
{
	...
	public Circle(int x, int y, int radius)
	{
		...
		itsRadius = radius;
		results =new java.lang.Long(java.lang.Math.round( 2 * radius* radius* java.lang.Math.PI));
		itsArea = results.intValue();
	}
	
	public void printIt ()
	{
		System.out.println("Circle: base = (" + baseX + ", " + baseY + "), ");
		System.out.println("radius = " + itsRadius + ", area = " + itsArea + ".");
	}
}
...
public class GeoObj
{
	public static void main (String args[])
	{
		...
		System.out.println();
		System.out.println("Type c to create a circle, " +"r to create a rectangle, " +"and q to quite.");
...
// so we know that they must have a printIt method.
			...
			for (int i = 1; i <= count; i++)
			{
				...
				System.out.println("Printing object number " + i + " from the list");
				element.printIt();
				System.out.println();
			}
		}
